...
FloorplanUI.prototype.adjustScale = function (sign) {
  ...
  switch (sign) {
    case '-': floorplan.scale -= 0.1; break
    case '+': floorplan.scale += 0.1; break
  }
  floorplan.scale = parseFloat((Math.round(floorplan.scale / 0.1) * 0.1).toFixed(2))
...
FloorplanUI.prototype.fillRowsWithNodes = function (iterator, element, selectedKey) {
  ...
  for (var i = 0; i < arr.length; i += 2) {
    ...
    if (arr[i + 1] != undefined && arr[i + 1] != null) {
      ...
      if (key1 === selectedKey) {
        element.innerHTML += '<div class="row"><div class="col-2"><p class="data clickable selectedKey" onclick="' + makeOnClick(key1) + '">' + name1 +
				'</p></div><div class="col-2"><p class="data clickable" onclick="' + makeOnClick(key2) + '">' + name2 + '</p></div></div>'
      } else if (key2 === selectedKey) {
        element.innerHTML += '<div class="row"><div class="col-2"><p class="data clickable" onclick="' + makeOnClick(key1) + '">' + name1 +
...
FloorplanUI.prototype.setSelectionInfo = function (node) {
  ...
  if (node.category === 'DoorNode') {
    element.innerHTML += '<div class="row"><p id="' + selectionInfoWindow.heightLabelId + '" class="data">Door Length: <br/><input id = "' + selectionInfoWindow.heightInputId + '" class = "dimensionsInput" name = "height" value = "' + height + '"/>' +
    ...
    element.innerHTML += '<div class="row"><div class="col-2"><p id="' + selectionInfoWindow.heightLabelId + '" class="data">Height: <br/><input id ="' + selectionInfoWindow.heightInputId + '" class = "dimensionsInput" name = "height" value = "' + height +
  ...
  if (node.category === 'WallGroup') {
    document.getElementById(selectionInfoWindow.heightLabelId).innerHTML = 'Length: <br/><input id="' + selectionInfoWindow.heightInputId +
