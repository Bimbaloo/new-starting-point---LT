...
(function (Z) {
  function H (b) { return L.call(b) === '[object Function]' } function I (b) { return L.call(b) === '[object Array]' } function y (b, c) { if (b) { var e; for (e = 0; e < b.length && (!b[e] || !c(b[e], e, b)); e += 1); } } function M (b, c) { if (b) { var e; for (e = b.length - 1; e > -1 && (!b[e] || !c(b[e], e, b)); e -= 1); } } function t (b, c) { return ga.call(b, c) } function l (b, c) { return t(b, c) && b[c] } function F (b, c) { for (var e in b) if (t(b, e) && c(b[e], e)) break } function Q (b, c, e, h) {
    c && F(c, function (c, j) {
      if (e || !t(b, j)) {
...
c, e, h)) : b[j] = c
    ...
    function c (a, f, b) {
      var d, m, c, g, e, h, j, i = f && f.split('/'); d = i; var n = k.map, p = n && n['*']; if (a && a.charAt(0) === '.') {
        if (f) {
...
h && (g = h, e = j); g && (f.splice(0, e, g), a = f.join('/'))
    ...
    } function e (a) { z && y(document.getElementsByTagName('script'), function (f) { if (f.getAttribute('data-requiremodule') === a && f.getAttribute('data-requirecontext') === i.contextName) return f.parentNode.removeChild(f), !0 }) } function h (a) { var f = l(k.paths, a); if (f && I(f) && f.length > 1) return f.shift(), i.require.undef(a), i.require([a]), !0 } function $ (a) { var f, b = a ? a.indexOf('!') : -1; b > -1 && (f = a.substring(0, b), a = a.substring(b + 1, a.length)); return [f, a] } function n (a, f,
...
d); if (t(r, d) && (!m || m.defineEmitComplete))f === 'defined' && b(r[d]); else if (m = q(a), m.error && f === 'error')b(m.error); else m.on(f, b)
  ...
  var a, f, b, d, m = (b = 1E3 * k.waitSeconds) && i.startTime + b < (new Date()).getTime(), c = [], g = [], j = !1, l = !0; if (!U) {
    U = !0; F(T, function (b) { a = b.map; f = a.id; if (b.enabled && (a.isDefine || g.push(b), !b.error)) if (!b.inited && m)h(f) ? j = d = !0 : (c.push(f), e(f)); else if (!b.inited && (b.fetched && a.isDefine) && (j = !0, !a.prefix)) return l = !1 }); if (m && c.length) {
      return b = A('timeout', 'Load timeout for modules: ' + c, null, c), b.contextName =
i.contextName, v(b)
    } l && y(g, function (a) { E(a, {}, {}) }); if ((!m || d) && j) if ((z || da) && !V)V = setTimeout(function () { V = 0; C() }, 50); U = !1
  }
...
} var U, X, i, N, V, k = {waitSeconds: 7, baseUrl: './', paths: {}, pkgs: {}, shim: {}, config: {}}, p = {}, T = {}, Y = {}, G = [], r = {}, S = {}, L = 1, M = 1; N = {require: function (a) { return a.require ? a.require : a.require = i.makeRequire(a.map) },
...
this.map.url; S[a] || (S[a] = !0, i.load(this.map.id, a))
    ...
    check: function () {
      if (this.enabled && !this.enabling) {
        var a, b, c = this.map.id; b = this.depExports; var d = this.exports, m = this.factory; if (this.inited) {
...
e = l(p, d.id)) { this.depMaps.push(d); if (this.events.error)e.on('error', u(this, function (a) { this.emit('error', a) })); e.enable() }
          ...
          m = u(this, function (a) { this.init([], function () { return a }, null, {enabled: !0}) }), m.error = u(this, function (a) { this.inited = !0; this.error = a; a.requireModules = [b]; F(p, function (a) { a.map.id.indexOf(b + '_unnormalized') === 0 && x(a.map.id) }); v(a) }), m.fromText = u(this, function (d, c) {
...
a); this.check()
    ...
    emit: function (a, b) { y(this.events[a], function (a) { a(b) }); a === 'error' && delete this.events[a] }}; i = {config: k,
      contextName: b,
      registry: p,
      defined: r,
      urlFetched: S,
      ...
      configure: function (a) {
        a.baseUrl && a.baseUrl.charAt(a.baseUrl.length - 1) !== '/' && (a.baseUrl += '/'); var b = k.pkgs, c = k.shim, d = {paths: !0, config: !0, map: !0}; F(a, function (a, b) { d[b] ? b === 'map' ? (k.map || (k.map = {}), Q(k[b], a, !0, !0)) : Q(k[b], a, !0) : k[b] = a }); a.shim && (F(a.shim, function (a, b) { I(a) && (a = {deps: a}); if ((a.exports || a.init) && !a.exportsFn)a.exportsFn = i.makeShimExports(a); c[b] = a }), k.shim = c); a.packages && (y(a.packages, function (a) {
      ...
      makeRequire: function (a, f) {
        function h (d, c, e) {
          var g, k; f.enableBuildCallback && (c && H(c)) && (c.__requireJsBuild = !0); if (typeof d === 'string') {
            if (H(c)) {
...
'Invalid require call'), e)
          ...
          toUrl: function (b) {
            var f, e = b.lastIndexOf('.'), g = b.split('/')[0]; if (e !== -1 && (!(g === '.' || g === '..') || e > 1)) {
            f = b.substring(e, b.length), b =
b.substring(0, e)
          } return i.nameToUrl(c(b, a && a.id, !0), f, !0)
          },
          defined: function (b) { return t(r, n(b, a, !1, !0).id) },
          specified: function (b) { b = n(b, a, !1, !0).id; return t(r, b) || t(p, b) }}); a || (h.undef = function (b) { w(); var c = n(b, a, !0), f = l(p, b); e(b); delete r[b]; delete S[c.url]; delete Y[b]; f && (f.events.defined && (Y[b] = f.events), x(b)) }); return h
      },
...
a); break
      ...
      onScriptLoad: function (a) { if (a.type === 'load' || ka.test((a.currentTarget || a.srcElement).readyState))P = null, a = J(a), i.completeLoad(a.id) },
...
a, [b.id]))
  ...
  } var j, w, x, C, J, D, P, K, q, fa, la = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg, ma = /[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g, ea = /\.js$/, ja = /^\.\//; w = Object.prototype; var L = w.toString, ga = w.hasOwnProperty, ia = Array.prototype.splice, z = !!(typeof window !== 'undefined' && typeof navigator !== 'undefined' && window.document), da = !z && typeof importScripts !== 'undefined', ka = z && navigator.platform === 'PLAYSTATION 3' ? /^complete$/ : /^(complete|loaded)$/, W = typeof opera !== 'undefined' &&
opera.toString() === '[object Opera]', E = {}, s = {}, R = [], O = !1; if (typeof define === 'undefined') {
  if (typeof requirejs !== 'undefined') { if (H(requirejs)) return; s = requirejs; requirejs = void 0 } typeof require !== 'undefined' && !H(require) && (s = require, require = void 0); j = requirejs = function (b, c, e, h) { var q, n = '_'; !I(b) && typeof b !== 'string' && (q = b, I(c) ? (b = c, c = e, e = h) : b = []); q && q.context && (n = q.context); (h = l(E, n)) || (h = E[n] = j.s.newContext(n)); q && h.configure(q); return h.require(b, c, e) }; j.config = function (b) { return j(b) }; j.nextTick = typeof setTimeout !==
...
: [q], !0
  ...
  var h, j; typeof b !== 'string' && (e = c, c = b, b = null); I(c) || (e = c, c = null); !c && H(e) && (c = [], e.length && (e.toString().replace(la, '').replace(ma, function (b, e) { c.push(e) }), c = (e.length === 1 ? ['require'] : ['require', 'exports', 'module']).concat(c))); if (O) { if (!(h = K))P && P.readyState === 'interactive' || M(document.getElementsByTagName('script'), function (b) { if (b.readyState === 'interactive') return P = b }), h = P; h && (b || (b = h.getAttribute('data-requiremodule')), j = E[h.getAttribute('data-requirecontext')]) }(j
