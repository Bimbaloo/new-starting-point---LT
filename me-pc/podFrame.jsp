          ...
          <el-row>
            ...
            <el-col :span="16">
              <div class="login-content-box">
                <div class="login-content" title="工单">
                  <i class="el-icon-tickets"></i>
                  <span>{{SHOPORDER}}</span>
                </div>
                <div class="login-content" title="站点">
                  <i class="el-icon-location"></i>
                  <span>{{site}}</span>
                </div>
                <div class="login-content" title="用户">
          ...
          <el-form label-position="center" label-width="85px" style="width: 100%">
            ...
            <el-col :span="colLength">
              <el-form-item label="SFC:">
                <el-input v-model.trim="SFC" v-uppercase @keyup.enter.native="enterSfc($event)" id="POD_SFC"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="4">
