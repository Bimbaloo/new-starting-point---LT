    ...
    <div id="reg" v-cloak>
        ...
        <el-row type="flex" justify="center">
        	<el-col :span="21">
		        <el-form class="demo-ruleForm">
		        	<el-col :span="7">
			        	<el-form-item label="<core:text name = "paoliao.jsp.order" />：" label-width="130px">
        ...
        <el-row type="flex" justify="center">
        	<el-col :span="21">
		        <el-form class="demo-ruleForm">
		        	<el-col :span="7">
			        	<el-form-item label="<core:text name = "paoliao.jsp.period" />：" label-width="130px">
									<el-input v-model="DATE_TIME" :disabled="true"></el-input>
			        	</el-form-item>
		        	</el-col>
		        	<el-col :span="7">
			        	<el-form-item label="<core:text name = "paoliao.jsp.pl_sfc" />：" label-width="130px">
									<el-input v-model="SFC" :disabled="true"></el-input>
			        	</el-form-item>
		        	</el-col>
		        	<el-col :span="7">
			        	<el-form-item label="<core:text name = "paoliao.jsp.sfc_qty" />：" label-width="150px">
