  ...
  <div id="app" v-cloak>
    ...
    <el-row type="flex" justify="center">
      <el-col :span="21">
        <el-form class="demo-ruleForm">
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.order" />：' :label-width=`${lableWidth.paoliaoDefault.SHOP_ORDER_WIDTH}px`>
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.item" />：' label-width="130px">
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.item_desc" />：' label-width="150px">
    ...
    <el-row type="flex" justify="center">
      <el-col :span="21">
        <el-form class="demo-ruleForm">
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.id" />：' label-width="130px">
            <el-input v-model="ID">
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.printer" />：' label-width="130px">
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.period" />：' label-width="150px">
