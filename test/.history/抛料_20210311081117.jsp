    ...
    <el-row type="flex" justify="center">
      <el-col :span="21">
        <el-form class="demo-ruleForm">
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.item" />：' :label-width=`${lableWidth.paoliaoDefault.order}px`>
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.item_desc" />：' :label-width=`${lableWidth.paoliaoDefault.order}px`>
