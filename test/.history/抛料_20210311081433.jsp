  ...
  <div id="app" v-cloak>
    ...
    <el-row type="flex" justify="center">
      <el-col :span="21">
        <el-form class="demo-ruleForm">
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.order" />：' :label-width=`${lableWidth.paoliao.order}px`>
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.item" />：' :label-width=`${lableWidth.paoliao.item}px`>
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.item_desc" />：' :label-width=`${lableWidth.paoliao.item_desc}px`>
    ...
    <el-row type="flex" justify="center">
      <el-col :span="21">
        <el-form class="demo-ruleForm">
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.id" />：' :label-width=`${lableWidth.paoliao.id}px`>
            <el-input v-model="ID">
