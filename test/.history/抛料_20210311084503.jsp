  ...
  <div id="app" v-cloak>
    ...
    <el-row type="flex" justify="center">
      <el-col :span="21">
        <el-form class="demo-ruleForm">
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.id" />：' :label-width=`${lableWidth.paoliao.id}px`  id='item_desc'>
            <el-input v-model="ID">
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.printer" />：' :label-width=`${lableWidth.paoliao.printer}px`>
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.period" />：' :label-width=`${lableWidth.paoliao.period}px`>
