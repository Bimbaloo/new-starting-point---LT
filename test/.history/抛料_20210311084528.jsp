  ...
  <div id="app" v-cloak>
    ...
    <el-row type="flex" justify="center">
      <el-col :span="21">
        <el-form class="demo-ruleForm">
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.order" />：' :label-width=`${lableWidth.paoliao.order}px` id='order'>
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.item" />：' :label-width=`${lableWidth.paoliao.item}px` id='item'>
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.item_desc" />：' :label-width=`${lableWidth.paoliao.item_desc}px` id='item_desc'>
    ...
    <el-row type="flex" justify="center">
      <el-col :span="21">
        <el-form class="demo-ruleForm">
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.id" />：' :label-width=`${lableWidth.paoliao.id}px`  id='id'>
            <el-input v-model="ID">
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.printer" />：' :label-width=`${lableWidth.paoliao.printer}px`  id='printer'>
          ...
          <el-col :span="7">
            <el-form-item label='<core:text name = " paoliao.jsp.period" />：' :label-width=`${lableWidth.paoliao.period}px` id='period'>
